<?php
/**
 * uswds Theme functions and definitions.
 *
...
function uswds_setup() {
	 ...
	 * If you're building a theme based on uswds Theme, use a find and replace
...
function uswds_scripts() {
	wp_enqueue_style( 'uswds-style', get_stylesheet_uri() );

	wp_enqueue_script( 'uswds-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'uswds-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
